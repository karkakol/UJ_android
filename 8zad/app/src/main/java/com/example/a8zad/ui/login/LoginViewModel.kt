...
class LoginViewModel() : ViewModel() {
    ...
    val authGithubApi = RetrofitHelper.getInstance("https://api.github.com/").create(AuthGithubApi::class.java)
    ...
    @OptIn(DelicateCoroutinesApi::class)
    fun registerWithExternalProvider(login: String, password: String, token: String, registerSource: String ){
        val response = runBlocking {
            GlobalScope.async {
